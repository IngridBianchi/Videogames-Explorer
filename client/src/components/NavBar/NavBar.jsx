  ...
  return (
    <div className={style.navContenedor}>
      ...
      <div  className={style.iconos}>
        <ul>
          <Link to={{pathname: 'https://www.instagram.com/in.bianchi/'}}  target='_blank'>
            <li><img src={I} alt='Instagram' /></li></Link>
          <Link to={{pathname: 'https://www.facebook.com/ingrid.lorenadr'}}  target='_blank'>
            <li><img src={F} alt='Facebook' /></li></Link>
          <Link to={{pathname: 'www.linkedin.com/in/ingrid-lorena-bianchi'}}  target='_blank'>
            <li><img src={L} alt='Linkedin' /></li></Link>
          <Link to={{pathname: 'https://github.com/IngridBianchi'}}  target='_blank'>
